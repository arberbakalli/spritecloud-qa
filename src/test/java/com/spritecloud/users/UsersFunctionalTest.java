...
public class UsersFunctionalTest extends BaseAPI {
    ...
    void getAllExistingUsers() {
        ...
        usersPage.getData().forEach(actualUser -> {
            var expectedUser = existingUsers.getData().stream()
            ...
            Assertions.assertThat(actualUser.getFirst_name()).isEqualTo(expectedUser.getFirst_name());
            Assertions.assertThat(actualUser.getLast_name()).isEqualTo(expectedUser.getLast_name());
    ...
    void evaluateDelayedRequest() {
        baseRequest
                ...
                .then()
                .statusCode(SC_OK).assertThat().time(lessThanOrEqualTo(3900L));
    }
}