...
//    }
    ...
    public String getFinalPrice() {
        String regex = "[0-9\\.]+";
        double subtotal = Double.parseDouble(extractValue(driver.findElement(itemPrice).getText(), regex));
        double tax = Double.parseDouble(extractValue(driver.findElement(taxPrice).getText(), regex));
        double total = Double.parseDouble(extractValue(driver.findElement(finalPrice).getText(), regex));
